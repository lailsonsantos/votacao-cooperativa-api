 ...
 *
 * <p>A descricao registra na propria documentacao viva a existencia das duas
 * superficies HTTP e a estrategia de versionamento, de modo que quem consome a
 * API entenda o contrato sem precisar abrir o repositorio.
 */
@Configuration
