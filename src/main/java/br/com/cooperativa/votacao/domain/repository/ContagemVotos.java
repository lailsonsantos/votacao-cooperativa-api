 ...
 *
 * <p>Projecao de interface do Spring Data: a consulta devolve uma linha por opcao, e nenhuma
 * entidade {@code Voto} e materializada. Com centenas de milhares de votos (Tarefa Bonus 2),
 * carregar as entidades para contar em memoria esgotaria a heap; a contagem agregada e resolvida
 * pelo indice.
 */
