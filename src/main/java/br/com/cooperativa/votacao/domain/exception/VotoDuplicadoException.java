 ...
 *
 * <p>Traduz a violacao da constraint {@code uk_voto_sessao_associado} em erro de negocio. A
 * deteccao acontece no banco, e nao em consulta previa, porque so o banco resolve corretamente a
 * corrida entre duas requisicoes simultaneas do mesmo associado.
 */
