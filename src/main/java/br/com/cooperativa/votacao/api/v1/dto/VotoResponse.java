...
public record VotoResponse(
     ...
     *
     * <p>O CPF volta <strong>mascarado</strong>. O associado ja sabe o proprio numero e nao precisa
     * recebe-lo de volta; devolver o dado completo apenas ampliaria a exposicao de dado pessoal em
     * caches, logs de proxy e historico de navegador.
     *
