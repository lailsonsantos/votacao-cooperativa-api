...
public record PautaResponse(UUID id, String titulo, String descricao, Instant criadaEm) {
     ...
     *
     * <p>A conversao e explicita e manual. Uma biblioteca de mapeamento resolveria o mesmo
     * problema, mas adicionaria uma dependencia e uma etapa de geracao de codigo para tres DTOs
     * &mdash; complexidade sem contrapartida.
     *
