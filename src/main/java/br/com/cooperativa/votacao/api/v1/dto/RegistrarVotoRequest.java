 ...
 *
 * <p>A validacao do CPF usa {@link CPF}, do Hibernate Validator, que ja acompanha o {@code
 * spring-boot-starter-validation}. A restricao confere os digitos verificadores e aceita o numero
 * com ou sem pontuacao, o que dispensa escrever o algoritmo a mao e faz a recusa acontecer na
 * borda, antes de qualquer acesso a banco ou chamada remota.
 *
 * <p>Declarar a regra aqui tambem melhora a resposta de erro: em vez de uma mensagem generica, o
 * cliente recebe o nome do campo que foi recusado.
 *
