 ...
 *
 * <p>Esta e a unica classe da aplicacao que conhece, ao mesmo tempo, o
 * vocabulario do dominio e o do protocolo. O dominio declara <em>o que</em>
 * aconteceu ({@link TipoErro}); a camada de API decide <em>como</em> isso se
 * expressa em HTTP.
 *
 * <p>Concentrar a traducao aqui e o que permite expor o mesmo dominio por outro
 * transporte &mdash; mensageria, gRPC &mdash; sem tocar em nenhuma regra. E e o
 * que mantem o principio aberto-fechado: uma regra nova reutiliza uma natureza
 * existente e esta classe nao muda.
 */
final class MapeadorDeStatus {
     ...
     *
     * <p>{@code EnumMap} em vez de {@code switch}: a tabela e um dado, nao um
     * fluxo, e fica legivel de uma so vez.
     */
