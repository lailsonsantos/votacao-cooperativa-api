 ...
 *
 * <p>Porta de entrada da aplicacao. Enquanto as portas de saida ({@code domain.repository}, {@code
 * application.port}) declaram o que a aplicacao precisa do mundo externo, esta interface declara o
 * que o mundo externo pode pedir a aplicacao.
 *
 * <p>A camada de API depende desta abstracao, e nao da implementacao. E o que permite que as duas
 * superficies HTTP &mdash; REST e telas do Anexo 1 &mdash; compartilhem o mesmo contrato sem
 * enxergar detalhe de implementacao, e o que torna trivial substituir o comportamento em teste.
 *
...
public interface PautaService {
     ...
     *
     * <p>A paginacao e obrigatoria por contrato: sem ela, uma cooperativa com milhares de pautas
     * produziria uma resposta ilimitada.
     *
